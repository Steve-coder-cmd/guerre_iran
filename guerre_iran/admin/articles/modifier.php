...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(isset($_FILES['image']) && $_FILES['image']['error'] === 0) {
        ...
        if(in_array($extension, $allowed)) {
            ...
            if($article['image'] && file_exists('../../front/images/' . $article['image'])) {
                unlink('../../front/images/' . $article['image']);
            }
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <img src="http://localhost:8090/images/<?= htmlspecialchars($article['image']) ?>" class="img-fluid mb-2" alt="Image actuelle">
